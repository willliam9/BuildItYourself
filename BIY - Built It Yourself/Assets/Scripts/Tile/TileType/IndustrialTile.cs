...
public class IndustrialTile : TileBuilding
{
    [SerializeField]
    private string name;
    [SerializeField]
    ...
    public IndustrialTile(Vector3 position, Vector3 rot, string name, string description, int price, int maxWorker, int earning, int happiness, int pollution, int trash, int electricity, int water)
        : base(position, rot, Building.Industrial, name, description, price, 30, 0, 0, 0, 0, 0)
    {
        Name = name;
